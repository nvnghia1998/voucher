                ...
                <?php $stt = 1;?>
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    <td class="center"><i class="fa fa-trash-o fa-fw "></i><a href="posts/deleted/{{$post->id}}" class='btn-del'> Delete</a></td>
                                    <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="posts/edit/{{$post->id}}">Edit</a></td>
                                </tr>
                                <?php $stt++;?>
                            @endforeach
